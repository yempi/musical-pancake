...
class Agent:
    def __init__(self):
        ...
        self.model = LinearQnet(11, 256, 3) #[size of the states, hidden layer size, output]
    ...
    def get_action(self, state):
        ...
        final_move = [0,0,0]
        if random.randint(0,200) < self.epsilon: # - epsilon, -frequent the randint will be from the epsilon
